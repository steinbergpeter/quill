...
import fileUploadPreview from '@/public/file-upload-preview.jpeg';
...
export default function Home() {
  return (
    <main>
      <MaxWidthWrapper className='mb-12 mt-8 sm:mt-16 flex flex-col items-center justify-center text-center'>
